# Node Clean Architecture API boilerplate

This is an updated version of a boilerplate I found <a href="https://github.com/talyssonoc/node-api-boilerplate">here</a>

## My Features

<dl>
  <dt>Updated Package.json</dt>
  <dd>
    Updated packages to latest versions and working on the rest of them.
  </dd>

  <dt>Mongoose Support</dt>
  <dd>
    Updated database model to use mongoose instead of sequelize.
    Updated Repository to be compatible with mongoose.
  </dd>

  <dt>Entity Generator</dt>
  <dd>
    Since this boilerplate have a big file structrue and adding new entity might be annoying I created a simple crud generator to be used as a kickstart for new entites.
  </dd>
</dl>
